    ...
    <thead>
      ...
      ?>
          <tr style="background-color:#dfe1e2; color:black;">
            ...
            <td> 
              <a href="<?php echo base_url(); ?>uploads/<?php echo $key->no_surat . ".pdf"?>" target="_blank">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="alert alert-info" id="exampleModalLabel">
            <h4 align="center">Data Surat Masuk</h4>
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <?php echo form_open_multipart('surat_masuk/action_add'); ?>
