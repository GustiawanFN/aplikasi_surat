 ...
 <div class="box">
  ...
  <div class="box-body">
    <?php foreach ($content->result() as $key): ?>
      <form action="<?php echo base_url(); ?>surat_keluar/action_update/<?php echo $key->id ?>" method="post">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" name="tanggal" autocomplete="off" value="<?php echo $key->tanggal ?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="tujuan" autocomplete="off" value="<?php echo $key->tujuan ?>">
          </div>
          <div class="form-group">
